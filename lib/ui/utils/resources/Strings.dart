class Strings {
  ...
  static const blogPod = "Blog & Podcast";
  ...
  static const personalSummaryBody =
      "I am a colorblind 24 year old basketball player with insatiable curiosity and a love for exploration. I have a deep appreciation for knowledge and I seek to expand my own with any opportunity presented. I have 2 main passions in life: technology and physical activity. My technology interest has driven me towards Mobile Development and I have been learning with Flutter for the past year now. I am also pursuing a professional basketball career at the moment, attempting to get my first contract with a team in Europe for the upcoming season. ";
  static const personalTechnologyPt1 =
      "I received a Computer Science degree with a minor in Mathematics from Loyola University - New Orleans in 2019. Currently, I am a Software Engineer focused on Full-Stack Mobile Development using the Flutter framework, the Dart coding language, Firebase as a database service and TypeScript for APIs. ";
  ...
  static const associates = "Associates Degree, with Honors";
  ...
  static const verifIDResponsibility0 =
      "Second most senior developer on the QuickConsent Mobile Application project.";
  static const verifIDResponsibility1 =
      "Assisted with the software architecture plans for the Front End - MVVM and VIPER combination. Our focus was on unidirectional data flow.";
  static const verifIDResponsibility2 =
      "Created the majority of UI Elements used throughout the app such as buttons, text fields, badges, logos, banners, etc.";
  static const verifIDResponsibility3 =
      "Responsible for creation and implementation of new screens as well as ensuring navigation/routing to the new screens were always functional.";
  static const verifIDResponsibility4 =
      "Assisted with API creation to prevent direct manipulation of data within the database via Front End functions. API was written in TypeScript and is portable to any type of database, SQL or NoSQL. Currently utilizing Firebase as a database service with a heavy focus on Firestore and Firebase Functions.";
  static const verifIDResponsibility5 =
      "Developed and implemented a completely new Database Model for the application for v2.0.0. New DB model was necessary to accommodate the inclusion of Auto-Renewing Subscriptions and a sharable FriendCode to promote organic growth.";
  static const verifIDResponsibility6 =
      "Assisted with the upgrade of all dependencies to include null safety version of Flutter (2.0+)";
  static const verifIDResponsibility7 =
      "Assisted with the upgrade of all Widgets and source code to include null safety version of Flutter (2.0+)";
  static const verifIDResponsibility8 =
      "Successfully implemented In-App purchasing via user's native operating system's payment method (Apple Pay and Google Pay).";
  static const verifIDResponsibility9 =
      "Stepped into SCRUM Master roll when the opportunity was presented.";
  static const verifIDResponsibility10 =
      "Assumed Project Manager responsibilities of writing User Stories, Product Descriptions and Single Source of Truth Documents.";
  static const responsibilityListForVerifID = [
    verifIDResponsibility0,
    verifIDResponsibility1,
    verifIDResponsibility2,
    verifIDResponsibility3,
    verifIDResponsibility4,
    verifIDResponsibility5,
    verifIDResponsibility6,
    verifIDResponsibility7,
    verifIDResponsibility8,
    verifIDResponsibility9,
    verifIDResponsibility10,
  ];

  static const ulapResponsibility0 =
      "ULAP was contracted to perform research on the Kubeflow platform and analyze its ability to handle the Machine Learning needs of our client.";
  static const ulapResponsibility1 =
      "Kubeflow is a unified Machine Learning platform created by Google that allows users to build end-to-end Machine Learning pipelines.";
  static const ulapResponsibility2 =
      "I was the lead author of the white paper produced by our small but highly skilled team of Machine Learning engineers. ";
  static const ulapResponsibility3 =
      "While writing the paper I was in close contact with the Kubeflow team at Google to receive updates and explanations regarding new version releases as the project went from v0.7 to v1.0.0";
  static const ulapResponsibility4 =
      "The white paper contained an explanation of Kubeflow as well as the results of our team's testing of the platform.";
  static const ulapResponsibility5 =
      "Following the completion of the white paper I was transitioned to a Data Engineer role with the company.";
  static const ulapResponsibility6 =
      "My duties as Data Engineer included code Quality Assurance and unit test writing to achieve above 90% code coverage.";
  static const responsibilityListForULAP = [
    ulapResponsibility0,
    ulapResponsibility1,
    ulapResponsibility2,
    ulapResponsibility3,
